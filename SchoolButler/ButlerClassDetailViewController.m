//
//  ButlerClassDetailViewController.m
//  SchoolButler
//
...
int const ClassDetailTextFieldCount = 3;



@implementation ButlerClassDetailViewController
...
@synthesize classID, classTitle, classStartDate, classEndDate;
...
{
    for (int index = 0; index < ClassDetailTextFieldCount; index++) {
        switch (index) {
            case 0:
...
- (IBAction)save:(id)sender
{
    ...
    if (incomingRow == 0) {
        ...
        theLine = [NSEntityDescription insertNewObjectForEntityForName:@"Classes" inManagedObjectContext:context];
        
        // title
        int existingCount = [projectIDArray count];
        [theLine setValue:[NSNumber numberWithInt:existingCount + 1] forKey:@"kp_ClassID"];
        [theLine setValue:titleField.text forKey:@"theClassName"];
        ...
        [theData setValue:titleField.text forKey:@"theClassName"];
    ...
    if (incomingRow == 0) {
        ...
        if (objects == nil) {
            ...
            for (NSManagedObject *oneObject in objects) {
                ...
                classTitle = [oneObject valueForKey:@"theClassName"];
        ...
        titleField.text = classTitle;
        startDateField.text = classStartDate;
        endDateField.text = classEndDate;
        
        
        // capture initial values (for edit.cancel)
        textFieldOriginalValues = [[NSMutableArray alloc] initWithCapacity:ClassDetailTextFieldCount];
        // initialize our array
        [textFieldOriginalValues addObject:classTitle];
